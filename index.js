...
const questionSet = [
   {
    number: 1,
    text: `Who is the player scored most gorl for the club?`,
    ans1: `Messi`,
    ans2: `Xavi`,
    ans3: `Harry`,
    ans4: `Valdes`
...
function handleStartButton() {
  ...
  const correctFeedback = `
    <section class="feedback-page" role="main">
      <h2>Correct!</h2>
      <img src="https://media2.giphy.com/media/ViZylgfPSfJFm/200w.webp?cid=790b76115cd4b59d7937746249918e1a&rid=200w.webp" alt="Messi winks.">
